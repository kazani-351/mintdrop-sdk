...
const styles = {
  note: {
    ...
    body: "text-green-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-green-900 prose-code:text-green-900 dark:text-slate-300 dark:prose-code:text-slate-300"
  },
  warning: {
    container:
