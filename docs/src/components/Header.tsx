  ...
  return (
    <header
      className={clsx(
        ...
        isScrolled
          ? "dark:bg-black/95 dark:backdrop-blur dark:[@supports(backdrop-filter:blur(0))]:bg-black-500/75"
          : "dark:bg-transparent"
      )}
    >
      ...
      <div className="relative flex items-center flex-grow basis-0">
        <Link href="/" aria-label="Home page">
          ...
          <Logo className="hidden w-auto text-black dark:text-white h-9 lg:block" />
        </Link>
      </div>
