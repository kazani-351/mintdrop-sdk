        ...
        <div className="grid items-center max-w-2xl grid-cols-1 px-4 mx-auto gap-y-16 gap-x-8 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              <p className="inline text-5xl tracking-tight text-transparent bg-gradient-to-r from-indigo-200 via-green-400 to-indigo-200 bg-clip-text font-display">
          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
                <div className="absolute h-px -top-px left-20 right-11 bg-gradient-to-r from-green-300/0 via-green-300/70 to-green-300/0" />
                    ...
                    {tabs.map((tab) => (
                      <div
                        ...
                        className={clsx(
                          ...
                          tab.isActive
                            ? "bg-gradient-to-r from-green-400/30 via-green-400 to-green-400/30 p-px font-medium text-green-300"
                            : "text-slate-500"
                        )}
                      >
                        <div
